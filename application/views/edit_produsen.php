...
<html lang="en">
    <head>
        ...
        <title>Edit Produsen - Cosmetics Safety and Halal Check</title>
    ...
    <body>
        <div class="container" style="padding-left: 150px; padding-right: 150px; padding-bottom: 50px;">
            ...
            <a type="button" class="btn btn-Light" href="<?php echo base_url('tabelprodusen') ?>" ><span class="material-icons">arrow_circle_left</span></a>
                <div class="row">
                <form method="post" action="" >
                    <div class="form-group" style="padding-right: 25px; padding-left: 25px;">
                        <label for="id">ID Produsen</label>
                    ...
                    <div class="form-group" style="padding-right: 25px; padding-left: 25px; padding-top: 10px;">
                        ...
                        <input type="text" class="form-control" name="nama_produsen" value = "<?= $row['nama_produsen']; ?>" >
                    </div>
                    <div class="mb-3" style="padding-right: 25px; padding-left: 25px; padding-top: 10px;">
                        <label for="alamat" class="form-label">Alamat Produsen</label>
                        <input class="form-control" id="exampleFormControlTextarea1" name="alamat_produsen" value = "<?= $row['alamat_produsen']; ?>" rows="3"></input>
                    </div>
                    <div class="form-group" style="padding-right: 25px; padding-left: 25px; padding-top: 10px;">
                        <label for="kontak">Kontak Produsen</label>
                        <input type="text" class="form-control" name="kontak_produsen" value = "<?= $row['kontak_produsen']; ?>" >
                    </div>
                    <br>
