                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-4">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Jenis Produk <span>| Last updated</span></h5>
                        ...
                        </div><!-- End Jenis Produk Card -->

                        <!-- Produk Card -->
                        <div class="col-xxl-4 col-md-4">
                            <div class="card info-card revenue-card">
                                <div class="card-body">
                                    <h5 class="card-title">Produk <span>| Last updated</span></h5>

                                    <div class="d-flex align-items-center">
                                        <div class="card-icon rounded-circle d-flex align-items-center justify-content-center btn-secondary">
                                            <i class="bi bi-box"></i>
                                        </div>
                                        <div class="ps-3">
                                            <h6><?= $jmlhproduk ;?></h6>
                        ...
                        <div class="col-xxl-4 col-xl-4">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Produsen <span>| Last updated</span></h5>
                        ...
                        <div class="col-md-8">
                            ...
                            <!-- Card with header and footer -->
                                ...
                                <div class="card-body">
                                    ...
                                    <p style="text-align: justify;">Hai Admin! Sebelum menginputkan data produk kosmetik, pastikan nama jenis kosmetik sudah tersedia didalam database. 
                                        Selanjutnya pastikan nama perusahaan (Produsen) sudah tersedia didalam database. Apabila belum tersedia inputkan terlebih dahulu data produsen, 
