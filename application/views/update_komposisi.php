...
<head>
    ...
    <title>Update Komposisi - Cosmetics Safety and Halal Check</title>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Update Komposisi</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                            ...
                            <form class="row g-3" method="POST" action="">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="id_komposisi" name="id_komposisi" value="<?= $row['id_komposisi']; ?>" readonly>
                                        <label for="floatingName">ID Komposisi</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="nama_komposisi" name="nama_komposisi" value="<?= $row['nama_komposisi']; ?>">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input class="form-control" id="deskripsi" name="deskripsi" style="height: 100px;" value="<?= $row['deskripsi']; ?>">
                                        <label for="floatingTextarea">Deskripsi</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input class="form-control" id="fungsi" name="fungsi" style="height: 100px;" value="<?= $row['fungsi']; ?>">
                                        <label for="floatingTextarea">Fungsi</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input class="form-control" id="efek" name="efek" style="height: 100px;" value="<?= $row['efek']; ?>">
                                        <label for="floatingTextarea">Efek</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input class="form-control" id="keterangan" name="keterangan" style="height: 100px;" value="<?= $row['keterangan']; ?>">
                                        <label for="floatingTextarea">Keterangan</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="status_aman" name="status_aman" value="<?= $row['status_aman']; ?>" readonly>
                                        <label for="floatingName">Status Aman</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="status_halal" name="status_halal" value="<?= $row['status_halal']; ?>" readonly>
                                        <label for="floatingName">Status Halal</label>
                                    </div>
                                </div>
