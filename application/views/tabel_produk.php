...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                <h5 class="card-title">Data Tabel Produk</h5>
                ...
                <table class="table datatable">
                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td><img src="<?= base_url() ?>assets/assets_dashboard/img/coba.png"></td>
                            <td><?php echo $row['sertifikasi_BPOM']; ?></td>
                            <td><?php echo $row['sertifikasi_MUI']; ?></td>
                            <td>
                            ...
                            <td><?php foreach ($produsen as $pro) : ?>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="<?= base_url();?>tabelproduk/edit/<?= $row['id_produk'];?>"
