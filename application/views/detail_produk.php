...
<head>
    ...
    <title>Details Produk - Cosmetics Safety and Halal Check</title>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Jenis Produk</div>
                                        <div class="col-lg-9 col-md-8"><?= $detail['nama_jenisproduk']; ?></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Produsen</div>
                                        <div class="col-lg-9 col-md-8"><?= $detail['nama_produsen']; ?></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Gender Produk</div>
                                        <div class="col-lg-9 col-md-8"><?= $detail['gender']; ?></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Sertifikasi BPOM</div>
                                        <div class="col-lg-9 col-md-8"><?php if ($detail['sertifikasi_BPOM'] == NULL) {
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Sertifikasi MUI</div>
                                        <div class="col-lg-9 col-md-8"><?php if ($detail['sertifikasi_MUI'] == NULL) {
                                            echo '<span class="material-icons" style="color: red;">report_gmailerrorred</span>';
                                        } else {
