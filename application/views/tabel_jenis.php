...
<head>
    ...
    <title>Tabel Jenis - Cosmetics Safety and Halal Check</title>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?php echo base_url('/tabeljenis') ?>" class="active">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Tabel Jenis Produk</h5>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Tambahkan Data Jenis Produk</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- Vertical Form -->
                                        <form class="row g-3" method="post" action="<?php echo base_url('/tabeljenis/tambah') ?>">
                                            <div class="col-12">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="nama_jenisproduk" name="nama_jenisproduk" placeholder="Nama Jenis Produk">
                                                    <label for="floatingName">Nama Jenis Produk</label>
                                                </div>
                                            </div>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['nama_jenisproduk']; ?></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="<?= base_url();?>tabeljenis/edit/<?= $row['id_jenisproduk'];?>"
                                                    class="btn btn-primary"><span class="material-icons">create</span></a>
                                                <a href="<?= base_url();?>tabeljenis/hapus/<?= $row['id_jenisproduk'];?>"
