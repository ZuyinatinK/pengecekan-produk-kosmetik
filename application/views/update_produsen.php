...
<head>
    ...
    <title>Update Produsen - Cosmetics Safety and Halal Check</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Update Produsen</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url('/admin') ?>">Home</a></li>
                    <li class="breadcrumb-item">Dataset</li>
                    <li class="breadcrumb-item">Data Produsen</li>
                    <li class="breadcrumb-item active">Update Produsen</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                            ...
                            <form class="row g-3" method="POST" action="">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="id_produsen" name="id_produsen" value="<?= $row['id_produsen']; ?>" readonly>
                                        <label for="floatingName">ID Produsen</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="nama_produsen" name="nama_produsen" value="<?= $row['nama_produsen']; ?>">
                                        <label for="floatingName">Nama Produsen</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input class="form-control" id="alamat_produsen" name="alamat_produsen" style="height: 100px;" value="<?= $row['alamat_produsen']; ?>">
                                        <label for="floatingName">Alamat Produsen</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="kontak_produsen" name="kontak_produsen" value="<?= $row['kontak_produsen']; ?>">
