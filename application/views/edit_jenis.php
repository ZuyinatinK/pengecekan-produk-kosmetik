...
<html lang="en">
    <head>
        ...
        <title>Edit Jenis Produk - Cosmetics Safety and Halal Check</title>
    ...
    <body>
        <div class="container" style="padding-left: 150px; padding-right: 150px; padding-bottom: 50px;">
            ...
            <a type="button" class="btn btn-Light" href="<?php echo base_url('tabeljenis') ?>" ><span class="material-icons">arrow_circle_left</span></a>
                <div class="row">
                
                <form method="post" action="" >
                    <div class="form-group" style="padding-right: 25px; padding-left: 25px;">
                        <label for="id">ID Jenis Produk</label>
                    ...
                    <div class="form-group" style="padding-right: 25px; padding-left: 25px; padding-top: 10px;">
                        <label for="judul">Nama Jenis Produk</label>
                        <input type="text" class="form-control" name="nama_jenisproduk" value = "<?= $row['nama_jenisproduk']; ?>" >
                    </div>			
                    <br>
